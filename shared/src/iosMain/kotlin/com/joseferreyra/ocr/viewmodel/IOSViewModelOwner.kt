...
class IOSViewModelOwner(
    ...
    val mainViewModel: OCRSessionListViewModel = ViewModelProvider.create(
        owner = this as ViewModelStoreOwner,
        factory = OCRSessionListViewModel.Factory,
        extras = OCRSessionListViewModel.newCreationExtras(appContainer),
    )[OCRSessionListViewModel::class]
